...
export default function Discover() {
    return (
        <div className="md:relative md:mb-20 mb-5">
            ...
            <div className="md:absolute text-white text-center xl:px-52 px-2 md:px-20 py-5 mx-2 md:mx-0 xl:py-24 md:py-10 bg-[#272F3C] md:top-[-50%] xl:left-[8.5%] bounce-animation">
