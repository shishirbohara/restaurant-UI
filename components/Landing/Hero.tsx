  ...
  return (
    <div className="relative w-full h-[700px]">
      ...
      >
        ...
        <h1 className="text-white absolute top-[30%] md:left-[23%] lg:left-[32%] xl:left-[26%] left-3 leading-10 md:leading-[55px] xl:text-6xl md:text-4xl text-3xl font-medium font-serif text-center tracking-widest">
