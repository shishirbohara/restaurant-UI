  ...
  return (
    <>
      <div className="flex md:gap-20">
        <div className="mb-60 -mt-5 w-full md:px-24 md:max-w-[800px]">
          ...
          <p className="md:my-8 my-4 px-2 leading-8 md:text-lg text-gray-600">
          ...
          <p className="leading-8 px-2 md:text-lg mb-10 text-gray-600">
          ...
          <Link href={"/"} className="border-y border-[#BCAF87] ml-28 md:text-2xl py-2 font-serif font-medium cursor-pointer hover:text-[#BCAF87] md:ml-44 transition-span">
        ...
        <div>
          <Image
            ...
            width={2000}
            height={1000}
            className="hidden md:block -mt-20 absolute top-[100%] right-0 object-cover h-[700px] w-[750px]"
          />
        </div>
      </div>
